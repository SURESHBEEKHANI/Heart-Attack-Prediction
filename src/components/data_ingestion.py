...
from src.components.model_trainer import ModelTrainerConfig  # type: ignore # Configuration for model training
from src.components.model_trainer import ModelTrainer  # type: ignore # Model training class
...
class DataIngestion:
    ...
    def initate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv('notebook\data\seattle-weather.csv')
